...
4. **Add your about page custom content.**
    ...
    1. Below we will provide you with an example of an about page that contains an Info section, a Vision section, a Video section, and a teams section.
    ...
    2. Below is the custom stylesheet for the `about.markdown` page to be added in the `custom.scss` file.
    ...
    3. Go back to your browser. Your about page should now look like this: 
